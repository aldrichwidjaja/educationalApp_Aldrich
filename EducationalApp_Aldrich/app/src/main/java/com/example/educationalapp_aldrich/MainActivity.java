...
public class MainActivity extends AppCompatActivity {
    ...
    public void setshare(View view) {
        ...
        sendIntent.putExtra(Intent.EXTRA_TEXT, "Math or Mad? \nPlay our game now IT IS VERY GOOD! \n Here: " + Uri.parse("https://drive.google.com/file/d/1EnjlmkGvBMbO0GucjwZZIeZJCEwETJux/view?usp=sharing"));
